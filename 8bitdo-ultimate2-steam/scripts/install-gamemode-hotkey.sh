...
echo ""
echo "Права на Bazzite: нужен udev uaccess (не SupplementaryGroups — даёт exit 216/GROUP):"
echo "  sudo ./scripts/install-gamemode-hotkey-udev.sh"
echo "  ./scripts/8bitdo-gamemode-check-perms.sh"
echo "  (переподключите геймпад после udev)"
echo ""
