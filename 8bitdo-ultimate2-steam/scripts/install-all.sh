...
echo "     - Start+Select+LB+RB → Monitor Game Mode"
echo "     - Start+Select+LT+RT → TV Game Mode"
echo ""
echo "Диагностика:"
...
echo ""
echo "HDR выбелен при входе в Game Mode (опционально):"
echo "  ручной фикс: QAM → Display → HDR выкл → вкл"
echo "  авто: ./scripts/install-hdr-workaround.sh  (лог: ~/.cache/8bitdo-hdr-nudge.log)"
echo "  Force Composite / Принудительная компоновка этот баг не чинит"
