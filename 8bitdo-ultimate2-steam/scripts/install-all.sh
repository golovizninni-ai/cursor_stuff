...
echo ""
echo "HDR выбелен при входе в Game Mode (опционально, отдельно от геймпада):"
echo "  1) Game Mode → Developer → Force Composite"
echo "  2) ./scripts/install-hdr-workaround.sh   # авто toggle HDR / composite"
echo "     лог: ~/.cache/8bitdo-hdr-nudge.log"
